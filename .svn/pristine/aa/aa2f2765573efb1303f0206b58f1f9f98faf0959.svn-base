				...
				<div class="_articleContent">
					<table class="_table _view w100">
						...
						<tbody>
							...
							<tr>
								<th>성명</th>
								<td colspan="3">${session.userName }</td>
							</tr>
							<tr>
							...
							<tr>
								<th>학과명(부서명)  <span class="mark">*</span></th>
								<td colspan="3">
							...
							<tr>
								...
								<td colspan="3">
									<span class="_button _minimum _green">
										<a  class="tabInnBtn" ng-click="pwdChange();">비밀번호 변경</a>
									</span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="3">
									...
									<input kr-input type="text" id="" class="wx180" ng-model="$root.member.modify.emailDomain"
										ng-change="changeEmail($root.member.modify.emailAddr,$root.member.modify.emailDomain);">
									<select name="mem_phone" id="mem_phone" class="_selectBox _fL wx185 mr05" ng-model="$root.member.modify.emailDomain"
										ng-change="changeEmail($root.member.modify.emailAddr,$root.member.modify.emailDomain);">

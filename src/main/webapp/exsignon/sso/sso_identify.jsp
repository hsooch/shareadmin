...
if(token != null && !"".equals(token.trim())) {
    ...
    if(!SUCCESS.equals(success)) {
        String id = RedisSessionUtils.getAttribute(request, SSO_SESSION_NAME);
        ...
        if(id != null && !"".equals(id.trim())) {
            ...
            RedisSessionUtils.setAttribute(request, SSO_SESSION_NAME, SSO_SESSION_ANONYMOUSE_IDENTIFY);
        }

    } else {
        String data = (String) obj.get(DATA_NAME);
        RedisSessionUtils.setAttribute(request, SSO_SESSION_NAME, data);
    }
} else {
    RedisSessionUtils.setAttribute(request, SSO_SESSION_NAME, SSO_SESSION_ANONYMOUSE_IDENTIFY);
}

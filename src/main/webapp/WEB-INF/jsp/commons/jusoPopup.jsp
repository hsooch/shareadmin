...
<% 
	...
	String confirmKey = request.getAttribute("addrConfirmKey").toString();
...
function init(){
	var url = '${serverDomain}address/popup.do';
	...
	if(inputYn !== "Y"){
		...
		document.form.action = location.protocol + "//www.juso.go.kr/addrlink/addrLinkUrl.do"; //인터넷망
